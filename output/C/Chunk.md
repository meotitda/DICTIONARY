...
<h2 id="http-메시지-전송에서">HTTP 메시지 전송에서</h2>
<p>청크는 HTTP 1.1프로토콜의 특별한 기능입니다. 메모리 관리에서와 별개의 의미를 지니는데,<br />
불편하게 <span style="color:#FFBF00; font-weight:bold;">커다란 메시지를 더 작은 "덩어리"로 쪼개는 기능</span>을 나타냅니다.</p>
<h2 id="데이터-중복-제거-데이터-동기화-및-원격-데이터-압축">데이터 중복 제거, 데이터 동기화 및 원격 데이터 압축</h2>
