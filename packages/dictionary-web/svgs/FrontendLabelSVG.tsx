...
const FrontendLabelSVG: FC<SvgIconProps> = ({ sx, ...props }) => {
  return (
    <SvgIcon
      {...props}
      sx={{
    ...
    >
      <rect width="68" height="15" fill="url(#pattern1)" />
      <defs>
        <pattern
          id="pattern1"
...
export default FrontendLabelSVG;
