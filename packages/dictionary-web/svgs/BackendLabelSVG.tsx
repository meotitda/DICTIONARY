...
const BackendLabelSVG: FC<SvgIconProps> = ({ sx, ...props }) => {
  return (
    <SvgIcon
      {...props}
      sx={{
    ...
    >
      <rect width="68" height="15" fill="url(#pattern3)" />
      <defs>
        <pattern
          id="pattern3"
...
export default BackendLabelSVG;
